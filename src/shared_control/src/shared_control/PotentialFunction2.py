...
class PotentialFunction:
    ...
    """
    def __init__(self, threshold_distance, neta, k_a, escape_constant, obstacle_position, init_q, goal, escape_points, print_file, gripper_active, escape_active):
    ...
    def updatePosition(self, actual_position):

        self._actual_positions = actual_position
    ...
    def updateParameters(self, actual_position, new_goal_distribution, new_obstacles = None, new_escape = None):
        """
        ...
        """
        self.updatePosition(actual_position)
    ...
    def getTotalPotential(self):
        ...
        #         else:
        #             total_rep_force = self.getRepulsivePotential(min_distance, idmin, ap)
    ...
    def getAttractivePotential(self):
        ...
        """
        ee_position = self._actual_positions
    ...
    def getCATwist(self, new_q, vmax, goal_distribution):
        ...
        twist_ca = self.getTotalPotential()
        twist_ca = Utils.setTwist(twist_ca, vmax)
        return twist_ca
